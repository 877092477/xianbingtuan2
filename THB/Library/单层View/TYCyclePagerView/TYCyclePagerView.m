...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if ([self.delegate respondsToSelector:@selector(pageViewDidCollectionView:ofsetX:)]) {
        [_delegate pageViewDidCollectionView:self.collectionView ofsetX:scrollView.contentOffset.x];
    }
