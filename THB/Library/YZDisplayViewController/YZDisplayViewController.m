...
- (UIColor *)selColor
{
    ...
    if (_selColor == nil) _selColor = RED;
...
- (UIView *)underLine
{
    if (_underLine == nil) {
        ...
        underLineView.backgroundColor = _underLineColor?_underLineColor:RED;
...
- (void)setUpUnderLineEffect:(void(^)(BOOL *isShowUnderLine,BOOL *isDelayScroll,CGFloat *underLineH,UIColor **underLineColor))underLineBlock
{
    ...
    if (underLineBlock) {
        ...
        _underLine.backgroundColor = _underLineColor?_underLineColor:RED;
    }
...
{
    [FNNotificationCenter postNotificationName:@"HomeSeleted" object:nil];
