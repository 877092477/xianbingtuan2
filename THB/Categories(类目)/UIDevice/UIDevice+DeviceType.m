...
+(NSString *)platformString{
    ...
    //iPhone
    if (XYScreenWidth == 320 && XYScreenHeight == 480) {
        return @"iPhone 4s";
    }
    if (XYScreenWidth == 320 && XYScreenHeight == 568) {
        return @"iPhone 5s";
    }
    if (XYScreenWidth == 375 && XYScreenHeight == 667) {
        return @"iPhone 6";
    }
    if (XYScreenWidth == 414 && XYScreenHeight == 736) {
