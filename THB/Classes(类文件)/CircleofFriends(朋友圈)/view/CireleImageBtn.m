...
- (void)layoutSubviews
{
    ...
    switch (buttonType) {
        ...
        case XYButtonTypeTitleLabelAndImageViewAndbgImageView:
        {
            ...
            CGSize imageSize = CGSizeMake(self.ImageWide, self.ImageHigh);
            CGSize finalSize = CGSizeZero;
            CGSize size = [self getSize];
            if(size.width>self.longestFloat){
                size=CGSizeMake(self.longestFloat, size.height);
            }
            ...
            if (_imageViewPosition == XYPositionLeft || _imageViewPosition == XYPositionRight) {
                ...
                CGFloat LabX = _imageViewPosition == XYPositionLeft ? imageSize.width + _subViewsMargin : 2;
                CGFloat imgVX = _imageViewPosition == XYPositionLeft ? 2 : size.width + _subViewsMargin;
