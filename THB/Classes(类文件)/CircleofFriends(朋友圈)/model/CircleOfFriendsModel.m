...
@implementation CircleOfFriendsModel
-(NSArray *)pic_urls{
...
@implementation CircleTypeModel

 

@end

@implementation CircleOfFriendsProductShareModel

@end

@implementation CircleOfFriendsProductModel

+ (NSDictionary *)mj_objectClassInArray{
    
    return @{@"img":[NSString class],
             @"share_content":[CircleOfFriendsProductShareModel class],
             @"share_img":[NSString class],
             @"imgData": [CircleOfFriendsImageModel class]};
}

@end

@implementation CircleOfFriendsImageModel
