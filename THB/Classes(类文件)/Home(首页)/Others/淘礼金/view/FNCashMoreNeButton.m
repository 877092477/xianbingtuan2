...
#import "FNCashMoreNeButton.h"

static CGFloat const originXY = 10.0;
static CGFloat const heightline = 1.0;

static NSInteger const tagButton = 1000;

@interface FNCashMoreNeButton () <UIScrollViewDelegate>
...
@implementation FNCashMoreNeButton
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _colorline = FNMainGobalTextColor;
