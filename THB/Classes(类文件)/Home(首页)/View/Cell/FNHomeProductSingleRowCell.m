...
@interface FNHomeProductSingleRowCell()
@property (nonatomic, strong) UIImageView *imgPlay;
@end

@implementation FNHomeProductSingleRowCell

+ (instancetype)cellWithCollectionView:(UICollectionView *)collectionView atIndexPath:(NSIndexPath *)indexPath{
    static NSString *reuseIdentifier = @"HomeViewGoodsSingleCell";
    FNHomeProductSingleRowCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
...
//    [self.ticketPriceLable sizeToFit];
    ...
    .sd_layout
    .leftSpaceToView(self.GoodsImage, 5)
    .topSpaceToView(self.qhPriceLabel, 5)
    .heightIs(20);
...
-(void)initNewUI{
    ...
    self.discountsBg2 = [[UIImageView alloc] init];
    [self.contentView addSubview: self.discountsBg2];
    ...
    self.ticketPriceLable.textColor=FNColor(246, 71, 111);
    self.ticketPriceLable.font=kFONT12;
    [self.contentView addSubview:self.ticketPriceLable];
...
//    .centerYEqualToView(self.GoodsTypeImage);
    ...
    //券背景视图
    [self.discountsBg2 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.GoodsImage.mas_right).offset(15);
    ...
    //    [self.ticketPriceLable sizeToFit];
    [self.ticketPriceLable mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.discountsBg2).offset(4);
        make.centerY.equalTo(self.discountsBg2);
        make.right.equalTo(self.discountsBg2).offset(-4);
    }];
    [self.ticketPriceLable setSingleLineAutoResizeWithMaxWidth:90];
    
    //下单文字背景
    [self.placeAnorderView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.discountsBg2.mas_right).offset(10);
        make.top.equalTo(self.discountsBg2.mas_top);
        make.height.equalTo(self.discountsBg2);
...
//    .heightIs(20);
    [self.qhPriceTitleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(self.GoodsImage.mas_right).offset(15);
        make.top.equalTo(self.discountsBg2.mas_bottom).offset(10);
    }];
...
//    .leftSpaceToView(self.qhPriceTitleLabel, 5)
//    //.topSpaceToView(self.discountsBgView, _jmsize_10)
//    .topSpaceToView(self.discountsBg2, 10)
//    .heightIs(20);
...
//    .centerYEqualToView(self.qhPriceTitleLabel)
//    .heightIs(20);
...
//                        _placeAnOrderLable.text=[NSString stringWithFormat:@"%@%@",model.fan_all_str,model.fcommission];//返回佣金
                        _placeAnOrderLable.text=model.fcommission_str;//返回佣金
...
//            price_fontcolor
            ...
            [self.placeAnorderView mas_makeConstraints:^(MASConstraintMaker *make) {
                if (self.discountsBg2.hidden) {
                    make.left.equalTo(self.discountsBg2);
                } else {
                    make.left.equalTo(self.discountsBg2.mas_right).offset(10);
                }
                make.top.equalTo(self.discountsBg2.mas_top);
