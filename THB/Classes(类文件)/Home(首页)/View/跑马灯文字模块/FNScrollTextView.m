...
@interface UIView (FNScrollTextViewExtension)
...
@implementation UIView (FNScrollTextViewExtension)
// getter
- (CGFloat)lmj_top{
...
@interface UILabel (FNScrollTextViewExtension)

@property (nonatomic) id lmj_text;

@end

@implementation UILabel (FNScrollTextViewExtension)
...
#define ScrollItemTime 3.f
#define DelayCallTime  3.f

@implementation FNScrollTextView{
