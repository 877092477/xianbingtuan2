...
//  THB
//
//  Created by Weller Zhao on 2019/2/14.
...
- (void)applyLayoutAttributes:(UICollectionViewLayoutAttributes *)attributes
{
    ...
    //获取每个section的页数，从0开始
    NSInteger page = allCount == 0 ? 0 : itemIndex / allCount;
    ...
    NSInteger pageRe = allCount == 0 ? 0 : ((itemCount % allCount == 0)? (itemCount / allCount) : (itemCount / allCount) + 1);
