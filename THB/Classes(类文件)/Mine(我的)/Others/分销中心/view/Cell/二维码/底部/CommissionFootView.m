...
#import "CommissionFootView.h"

#import "XYFXMenuView.h"
#define MenuH 167
@interface CommissionFootView ()<UIGestureRecognizerDelegate>
...
@implementation CommissionFootView
...
-(void)addContentView{
    ...
    _imgArray = [NSMutableArray arrayWithObjects:@"weixin",@"friend",@"weibo",@"qq", nil];
    
    _titleArray = [NSMutableArray arrayWithObjects:@"微信",@"朋友圈",@"新浪微博",@"QQ", nil];
