...
@property (weak, nonatomic) IBOutlet UILabel *ddzLabel;

@property (weak, nonatomic) IBOutlet UILabel *successedLabel;

@property (weak, nonatomic) IBOutlet UILabel *tyLabel;

@property (weak, nonatomic) IBOutlet UILabel *wjsLabel;
