...
typedef void(^CallBackBlcok) ();//回调

@interface LoginViewController : SuperViewController<UIApplicationDelegate>
...
@property (nonatomic,copy)CallBackBlcok callBackBlock;//block
