//
//  FNUpgradeOrderListNeController.m
//  THB
//
...
#import "FNUpgradeOrderListNeController.h"

//controller
#import "OrderListViewController.h"

@interface FNUpgradeOrderListNeController ()

@end

@implementation FNUpgradeOrderListNeController
...
- (void)setupChildVc
{
    NSArray *titleArray = [NSArray arrayWithObjects:@"全部订单",@"已付款",@"已发货",@"已签收",@"无效",nil];
