...
@protocol FNCollectionHeaderNeLayoutDelegate <NSObject>
...
@interface FNCollectionHeaderNeLayout : UICollectionViewFlowLayout
// item 的行距（默认4.0）
...
@property (nonatomic, weak) id<FNCollectionHeaderNeLayoutDelegate> delegate;
