...
@protocol FNSpquantityNeViewDelegate <NSObject>
...
@interface FNSpquantityNeView : UICollectionReusableView
...
@property (nonatomic, weak) id<FNSpquantityNeViewDelegate> delegate;
