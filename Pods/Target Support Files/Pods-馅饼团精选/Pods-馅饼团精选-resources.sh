...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "EBBannerView/EBBannerView/Classes/EBBannerView.xib"
  install_resource "EBBannerView/EBBannerView/Classes/EBBannerViewController.xib"
  install_resource "EBBannerView/EBBannerView/Classes/EBMuteDetector.mp3"
  install_resource "IQKeyboardManager/IQKeyBoardManager/Resources/IQKeyboardManager.bundle"
  install_resource "JPVideoPlayer/JPVideoPlayer/JPVideoPlayer.bundle"
  ...
  install_resource "UMCCommonLog/UMCommonLog/UMCommonLog.bundle"
